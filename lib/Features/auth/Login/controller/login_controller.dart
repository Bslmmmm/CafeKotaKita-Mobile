  ...
  void _showSuccessDialog(String title, String message, VoidCallback onOkPressed) {
    Get.dialog(
      AlertDialog(
        ...
        content: Text(message, style: AppTextStyles.poppinsBody(color: clrfont2)),
        actions: [
          TextButton(
            onPressed: () {
              Get.back();
  ...
  void _showErrorDialog(String message) {
    Get.dialog(
      AlertDialog(
        ...
        title: Text("Error", style: AppTextStyles.montserratH1(color: white)),
        content: Text(message, style: AppTextStyles.poppinsBody(color: white)),
        actions: [
          TextButton(
            onPressed: () => Get.back(),
            child: Text("OK", style: AppTextStyles.poppinsBody(color: white, weight: AppTextStyles.semiBold)),
